...
static int __init led_init(void)
{
	...
	*/
	...
	else/*没有定义设备号*/
	{
		...
		if(ret < 0)
		{
			pr_err("%s could not alloc_chrdev_region, ret = %d\r\n",NEWCHRLED_NAME,ret);
			goto fail_map;
		}
